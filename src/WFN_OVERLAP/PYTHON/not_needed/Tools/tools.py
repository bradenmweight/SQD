...
# NOTE: prefer space for indent, please use spaces; & pep-8 say spaces are better.
# Use 4 spaces per indentation level.
# @ http://www.python.org/dev/peps/pep-0008/#indentation
# $ du
#  Read the interface between surface-hopping code and  qc calculations
#  Use Json format for internal data exchange. serialization
...
#    print "--- read whole interface file ---"
    ...
    for cur_line in line_each:
        ...
        i_find_state1 = re.search('Number of electronic states', cur_line)
